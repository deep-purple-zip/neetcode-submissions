...
print(
    f"Initial Attributes: {whiskers.name} ({whiskers.species}) "
    f"- Hunger: {whiskers.hunger}, Energy: {whiskers.energy}"
)
...
print(
    f"Modified Attributes: {whiskers.name} ({whiskers.species}) "
    f"- Hunger: {whiskers.hunger}, Energy: {whiskers.energy}"
)
